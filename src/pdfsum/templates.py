...
_LABELS: dict[str, dict[str, str]] = {
    "pt": {
        "titulo": "Título",
        "autores": "Autores / Filiação",
        "tipo_estudio": "Tipo de estudo",
        "objetivo": "Objetivo",
        "metodos": "Métodos",
        ...
        "entidad": "Entidade(s) emissora(s)",
        "objeto_alcance": "Objeto e alcance",
        "estructura": "Estrutura",
        "sintesis": "Síntese por seção",
        "publico": "Público-alvo",
        "resumen_ejecutivo": "Resumo executivo",
        "puntos_clave": "Pontos-chave",
        "terminos": "Termos técnicos / entidades",
    },
    "es": {
        "titulo": "Título",
        "autores": "Autores / Filiación",
        ...
        "tipo_documento": "Tipo de documento",
        "entidad": "Entidad(es) emisora(s)",
        "objeto_alcance": "Objeto y alcance",
        "estructura": "Estructura",
        "sintesis": "Síntesis por sección",
        "publico": "Público objetivo",
        "resumen_ejecutivo": "Resumen ejecutivo",
        "puntos_clave": "Puntos clave",
        "terminos": "Términos técnicos / entidades",
    },
    "en": {
        "titulo": "Title",
        "autores": "Authors / Affiliation",
        "tipo_estudio": "Study type",
        "objetivo": "Objective",
        "metodos": "Methods",
        "resultados": "Results",
        ...
        "entidad": "Issuing entity(ies)",
        "objeto_alcance": "Scope",
        "estructura": "Structure",
        "sintesis": "Section synthesis",
        "publico": "Target audience",
        "resumen_ejecutivo": "Executive summary",
        "puntos_clave": "Key points",
        "terminos": "Technical terms / entities",
    },
}
