...
class TestAcceptance(unittest.TestCase):
    def test_load_set(self):
        ...
        with TemporaryDirectory() as td:
            ...
            p.write_text(json.dumps([
                {"doc_id": "d1", "expected_lang": "pt",
                 "expected_type": "articulo", "expected_terms": ["a", "b"]},
            ]), encoding="utf-8")
    ...
    def test_verdict(self):
        ...
        good = {"total": 2, "coverage_media": 0.9,
                "lang_aciertos": 2, "type_aciertos": 2}
        self.assertTrue(acceptance_verdict(good, 0.6).passed)

        low_cov = {"total": 2, "coverage_media": 0.4,
                   "lang_aciertos": 2, "type_aciertos": 2}
        self.assertFalse(acceptance_verdict(low_cov, 0.6).passed)

        lang_fail = {"total": 2, "coverage_media": 0.9,
                     "lang_aciertos": 1, "type_aciertos": 2}
